...
public class NormalizePredicateBench {
    ...
    public void setup() {
        ...
        System.err.println("generate randomPredicate: " + randomPredicate);
        disjunctive = generateDisjunctive();
        System.err.println("generate disjunctive: " + disjunctive);
    }

    private BinaryPredicateOperator.BinaryType randomBinary() {
        int n = ThreadLocalRandom.current().nextInt(6);
        return BinaryPredicateOperator.BinaryType.values()[n];
    }
